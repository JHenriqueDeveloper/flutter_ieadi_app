    ...
    return Consumer<SetorRepository>(
      builder: (_, state, __) {
        ...
        Widget _buttonSave() => SizedBox(
              ...
              child: ElevatedButton(
                            ...
                            context.read<SetorRepository>().addSetor(
                                  ...
                                  onFail: (e) {
                                    ...
                                    _snackBar(
                                      context: context,
                                      msg:
                                          'Não foi possivel adicionar o Setor: $e',
                                      isSuccess: false,
                                    );
                                  },
                                  onSuccess: (uid) {
                ...
                child: !state.isLoading
                    ? Text(setor?.id == null ? 'Adicionar' : 'Atualizar')
                    : SizedBox(
                        height: 28,
                        width: 28,
        ...
        return DefaultForm(
          ...
          page: 16,
          title: setor?.nome ?? 'Adicionar Setor',
          form: [
            SizedBox(height: 32),
            TextFormField(
              ...
              onSaved: (value) => setor?.setNome = value,
              initialValue: setor?.nome ?? null,
            ),
            SizedBox(height: 16),
            ListTile(
              ...
              trailing: DropdownButton(
                ...
                value: setor?.sede,
                hint: Text('Escolha'),
                onChanged: (value) => setState(() => setor.setSede = value),
                style: Theme.of(context).textTheme.bodyText1,
            ...
            setor?.id != null
                ...
                : SizedBox(),
            setor?.id != null ? SizedBox(height: 16) : SizedBox(),
            setor?.id != null
                ? ListTile(
                    //tileColor: LightStyle.paleta['PrimariaCinza'],
                    title: Text(
                    ...
                    trailing: Switch(
                      ...
                      onChanged: (bool value) =>
                          setState(() => setor.isActive = value),
                      value: setor?.isActive ?? false,
                    ),
                  )
                : SizedBox(),
            SizedBox(height: 32),
