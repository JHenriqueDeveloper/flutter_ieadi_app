...
class CertificadoApresentacao extends StatefulWidget{
  CertificadoApresentacao();
  _CertificadoApresentacaoState createState() => _CertificadoApresentacaoState();
}

class _CertificadoApresentacaoState extends State<CertificadoApresentacao>{
