...
class CartaRecomendacao extends StatefulWidget{
  CartaRecomendacao();
  _CartaRecomendacaoState createState() => _CartaRecomendacaoState();
}

class _CartaRecomendacaoState extends State<CartaRecomendacao>{
