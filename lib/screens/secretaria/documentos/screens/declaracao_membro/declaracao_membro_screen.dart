...
class DeclaracaoMembro extends StatefulWidget{
  DeclaracaoMembro();
  _DeclaracaoMembroState createState() => _DeclaracaoMembroState();
}

class _DeclaracaoMembroState extends State<DeclaracaoMembro>{
