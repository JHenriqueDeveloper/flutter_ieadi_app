...
class CredencialMinisterio extends StatefulWidget{
  CredencialMinisterio();
  _CredencialMinisterioState createState() => _CredencialMinisterioState();
}

class _CredencialMinisterioState extends State<CredencialMinisterio>{
